...
const planes = [
	...
	},
	{
		nombre: "Pro",
		precio: "$ 4.99",
		descripcion: "Para clientes frecuentes que quieren ahorrar y recibir mas rapido.",
	...
	},
	{
		nombre: "Enterprise",
		precio: "Por correo",
		descripcion: "Para oficinas, familias grandes o negocios que compran por volumen.",
		etiqueta: "A medida",
		icon: Users,
		accion: "Contactar",
		destacado: false,
						...
						<div className="rounded-xl border bg-card p-6">
							...
							<div className="max-w-3xl">
								...
								<p className="mt-3 text-muted-foreground">
									Planes diseñados para que comprar sea más fácil, conveniente y rentable. Disfruta mayor comodidad, mejores ofertas, delivery prioritario y beneficios especiales para compras grandes.
								</p>
							</div>
						</div>
									...
									<CardContent className="space-y-4">
										...
										>
											{plan.nombre === "Enterprise" ? (
												...
												<>
													{plan.nombre === "Pro" ? <CreditCard /> : <ShieldCheck />}
													{plan.accion}
												</>
											)}
										</Button>
